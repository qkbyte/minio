...
func genLDFlags(version string) string {
	...
	ldflagsStr := "-s -w"
	ldflagsStr += " -X github.com/qkbyte/minio/cmd.Version=" + version
	ldflagsStr += " -X github.com/qkbyte/minio/cmd.CopyrightYear=" + copyrightYear
	ldflagsStr += " -X github.com/qkbyte/minio/cmd.ReleaseTag=" + releaseTag
	ldflagsStr += " -X github.com/qkbyte/minio/cmd.CommitID=" + commitID()
	ldflagsStr += " -X github.com/qkbyte/minio/cmd.ShortCommitID=" + commitID()[:12]
	ldflagsStr += " -X github.com/qkbyte/minio/cmd.GOPATH=" + os.Getenv("GOPATH")
	ldflagsStr += " -X github.com/qkbyte/minio/cmd.GOROOT=" + os.Getenv("GOROOT")
	return ldflagsStr
}
