...
var (
	ErrInvalidFSValue = newErrFn(
		...
		"MinIO does not support newer NAS gateway deployments anymore refer https://github.com/qkbyte/minio/issues/14331",
	)
...
Refer to the link https://github.com/qkbyte/minio/tree/master/docs/erasure/storage-class for more information`,
	)
