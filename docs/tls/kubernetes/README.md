...
For testing purposes, here is [how to create self-signed certificates](https://github.com/qkbyte/minio/tree/master/docs/tls#3-generate-self-signed-certificates).
