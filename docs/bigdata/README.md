...
![cloud-native](https://github.com/qkbyte/minio/blob/master/docs/bigdata/images/image1.png?raw=true "cloud native architecture")
...
![ambari-login](https://github.com/qkbyte/minio/blob/master/docs/bigdata/images/image3.png?raw=true "ambari login")

### **3.1 Configure Hadoop**

Navigate to **Services** -> **HDFS** -> **CONFIGS** -> **ADVANCED** as shown below

![hdfs-configs](https://github.com/qkbyte/minio/blob/master/docs/bigdata/images/image2.png?raw=true "hdfs advanced configs")

Navigate to **Custom core-site** to configure MinIO parameters for `_s3a_` connector

![s3a-config](https://github.com/qkbyte/minio/blob/master/docs/bigdata/images/image5.png?raw=true "custom core-site")
...
![hdfs-services](https://github.com/qkbyte/minio/blob/master/docs/bigdata/images/image7.png?raw=true "hdfs restart services")

### **3.2 Configure Spark2**

Navigate to **Services** -> **Spark2** -> **CONFIGS** as shown below

![spark-config](https://github.com/qkbyte/minio/blob/master/docs/bigdata/images/image6.png?raw=true "spark config")

Navigate to “**Custom spark-defaults**” to configure MinIO parameters for `_s3a_` connector

![spark-config](https://github.com/qkbyte/minio/blob/master/docs/bigdata/images/image9.png?raw=true "spark defaults")
...
![spark-config](https://github.com/qkbyte/minio/blob/master/docs/bigdata/images/image12.png?raw=true "spark restart services")

### **3.3 Configure Hive**

Navigate to **Services** -> **Hive** -> **CONFIGS**-> **ADVANCED** as shown below

![hive-config](https://github.com/qkbyte/minio/blob/master/docs/bigdata/images/image10.png?raw=true "hive advanced config")

Navigate to “**Custom hive-site**” to configure MinIO parameters for `_s3a_` connector

![hive-config](https://github.com/qkbyte/minio/blob/master/docs/bigdata/images/image11.png?raw=true "hive advanced config")
...
![hive-config](https://github.com/qkbyte/minio/blob/master/docs/bigdata/images/image13.png?raw=true "hive advanced custom config")

Once the config changes are applied, proceed to restart all Hive services.

![hive-config](https://github.com/qkbyte/minio/blob/master/docs/bigdata/images/image14.png?raw=true "restart hive services")
